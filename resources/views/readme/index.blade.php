...
<head>
    ...
    <link rel="stylesheet" href="{{url('readme/assets/css/documenter_style.css')}}" media="all">
    <link rel="stylesheet" href="{{url('readme/assets/css/jquery.mCustomScrollbar.css')}}" media="all">

    <script src="{{url('readme/assets/js/jquery.js')}}"></script>
    <script src="{{url('readme/assets/js/jquery.scrollTo.js')}}"></script>
    <script src="{{url('readme/assets/js/jquery.easing.js')}}"></script>
    <script src="{{url('readme/assets/js/jquery.mCustomScrollbar.js')}}"></script>
    <script>
        document.createElement('section');
        var duration = '500',
            easing = 'swing';
    </script>
    <script src="{{url('readme/assets/js/script.js')}}"></script>
</head>

<body>
    <div id="documenter_sidebar">
        <img src="{{url('readme/assets/images/logo.png')}}" style="border: none;margin: 20px 20px 0;width: 180px">
    ...
    <div id="documenter_content">
        <section id="documenter_cover">
            ...
            <ul>
                <li>by: DZ-DEV</li>
                <li>email: <a href="mailto:bouzekriyoucef@gmail.com">bouzekriyoucef@gmail.com</a></li>
            </ul>
        ...
        <section id="update">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/update1.png')}}">
            </p>
            <p>Select your source and target database and click compare now.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update2.png')}}">
            </p>
            <p>After comparing successfully two database click ok.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update3.png')}}">
            </p>
            <p>Then select the checkbox and click Diployment Wizard.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update4.png')}}">
            </p>
            <p>Uncheck the Recompare after deployment checkbox and click next.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update5.png')}}">
            </p>
            <p>Click Deploy now.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update6.png')}}">
            </p>
            <p>Click Ok.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/update7.png')}}">
            </p>
            ...
            <p><strong>Still facing problem? Don't worry! We can update your software for USD 10. Please contact us at
                    <a href="mailto:bouzekriyoucef@gmail.com">bouzekriyoucef@gmail.com</a>.</strong></p>
        </section>
        <section id="pos-printer">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer1.png')}}">
            </p>
            <p>
                Then go to Devices and printers.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer2.png')}}">
            </p>
            <p>
                Set your POS printer as default printer.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer3.png')}}">
            </p>
            <p>
                Then go to Printing preferences.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer4.png')}}">
            </p>
            <p>
                Then go to Advanced.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer5.png')}}">
            </p>
            <p>
                Select 3rd option of paper size and click Ok.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer6.png')}}">
            </p>
            <p>
                After that go to printer properties.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer7.png')}}">
            </p>
            <p>
                Go to device settings and select 3rd option of auto.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer8.png')}}">
            </p>
            <p>
                Please make sure you choose correct paper size(3rd option) when you want to print the invoice.
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/pos_printer9.png')}}">
            </p>
        </section>
        <section id="mail">
            <div class="page-header">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/mail1.png')}}">
            </p>
        </section>
        <section id="dashboard">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/dashboard1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/dashboard4.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/dashboard5.png')}}">
            </p>
            <p>A bar chart shows Yearly report of purchases and sales of current year.</p>
            <p><img alt="" src="{{url('readme/assets/images/dashboard2.png')}}"></p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/dashboard3.png')}}"></p>
        </section>
        <section id="product">
            <div class="page-header">
                <h3>PRODUCT</h3>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/category1.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/category2.png')}}">
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/category3.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/category4.png')}}">
            </p>
            <p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/category5.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/category6.png')}}">
            </p>
            <p>To export data from specific row you just have to check the checkbox of the related row</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/category9.png')}}">
            </p>
            ...
            <p>You can add, edit and delete product. You can import product from CSV. <strong>You must follow the
                ...
                sample file.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/product1.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/product2.png')}}">
            </p>
            <p>You can sort table data according to column</p>
            <p><img alt="" src="{{url('readme/assets/images/product3.png')}}"></p>
        ...
        <section id="purchase">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/purchase1.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/purchase2.png')}}">
            </p>
            <p>You can also edit product info from order table.</p>
            <p><img alt="" src="{{url('readme/assets/images/purchase3.png')}}"></p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/purchase4.png')}}"></p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/purchase7.png')}}"></p>
            ...
            <p>You can make payment from Purchase table. You can make payment with Cash, Gift Card, Cheque, Credit card
                and Deposit.</p>
            <p><img alt="" src="{{url('readme/assets/images/purchase5.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/purchase6.png')}}">
            </p>
        ...
        <section id="sale">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/sale1.png')}}">
                <img alt="" src="{{url('readme/assets/images/sale2.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/sale3.png')}}">
            </p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/sale4.png')}}"></p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/sale6.png')}}"></p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/sale5.png')}}"></p>
            <h2><strong>Payment</strong></h2>
            ...
            <p><img alt="" src="{{url('readme/assets/images/delivery1.png')}}"></p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/gift_card1.png')}}">&nbsp;&nbsp;
                <img alt="" src="{{url('readme/assets/images/gift_card2.png')}}">
            </p>
        </section>
        <section id="expense">
            <div class="page-header">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/expense1.png')}}">
            </p>
            <h2><strong>Expense</strong></h2>
            <p>You can create, edit and delete expense in Expense module.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/expense2.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        <section id="quotation">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/quotation1.png')}}">
            </p>
            ...
            <p><img alt="" src="{{url('readme/assets/images/quotation2.png')}}">
            </p>
            <h2><strong>Create Purchase</strong></h2>
            <p>You can create purchase from Quotation.</p>
            <p><img alt="" src="{{url('readme/assets/images/quotation3.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        <section id="adjustment">
            ...
            <p>You can adjust product quantity in Quantity Adjustment module. There will be two operation: Subtraction
                and Addition</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/adjustment1.png')}}">
                <img alt="" src="{{url('readme/assets/images/adjustment2.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        ...
        <section id="transfer">
            ...
            <p>You can transfer your product from one warehouse to another in Transfer module. You can also transfer
                ...
                the table row.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/transfer1.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        <section id="return">
            ...
            <p>You can return your product with Return module. You can track return of both purchase and sale with this
                ...
                table row.</p>
            <p>
                <img alt="" src="{{url('readme/assets/images/return1.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        <section id="accounting">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/accounting_1.png')}}">
            </p>
        ...
        <section id="people">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/user1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/customer1.png')}}">
            </p>
            <p>
                <img alt="" src="{{url('readme/assets/images/customer2.png')}}">
            </p>
            ...
            <p>Biller is the representative of your company. You may have multiple company and you want to manage all
                ...
                also import biller with CSV file. <strong>You must follow the instruction to import data from
                    CSV.</strong></p>
            <p>
                <img alt="" src="{{url('readme/assets/images/biller1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/supplier1.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
        </section>
        ...
        <section id="setting">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/role1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/warehouse1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/customer_group1.png')}}">
            </p>
            ...
            <p>You can create, edit and delete product brand. You can also import brand with CSV file. <strong>You must
                    follow the instruction to import data from CSV.</strong></p>
            <p>
                <img alt="" src="{{url('readme/assets/images/brand1.png')}}">
            </p>
            ...
            <p>You can create, edit and delete product unit. You can also import brand with CSV file. <strong>You must
                    follow the instruction to import data from CSV.</strong></p>
            <p>
                <img alt="" src="{{url('readme/assets/images/unit1.png')}}">
            </p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/tax1.png')}}">
            </p>
            <p>And you can search, export and print data from table that we discussed in <a href="#product">Product</a>
                section.</p>
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/pos1.png')}}">
            </p>
        ...
        <section id="translation">
            ...
            <p>
                <img alt="" src="{{url('readme/assets/images/translation.png')}}">
            </p>
